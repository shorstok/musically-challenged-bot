...
1) Прием ботом @nsctheorbot заданий от участников с помощью команды /<code>tasksuggest</code> <b>(команда отсылается в *личке* боту)</b>. Приём задание закончится в <b>{LocTokens.Deadline}</b>.
